...
def test_build_read_only_smoke_plan_requires_test_contour_and_complete_alor_config() -> None:
    ...
    with pytest.raises(ValueError, match="refresh token and portfolio"):
        build_read_only_smoke_plan(incomplete_settings)


def test_run_read_only_smoke_exchanges_token_and_hits_read_only_account_surfaces() -> None:
